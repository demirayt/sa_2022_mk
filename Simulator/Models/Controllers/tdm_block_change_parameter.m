...
function res = tdm_block_change_parameter(x,y,t,ev,param,flag,model_no)

global empty3 storage currentmodel
...
if nargin == 0
clc;
disp('Model: tdm_block_change_parameter');
disp('dynamic_states:  xtime');
disp('events:  evTrigger');
disp('parameters:  Ton modelid parameterid newvalue');
disp('--------------------------------------------------');
disp('Summary:');
disp('--------------------------------------------------');
disp('Number of x = 1');
