...
function res = MDL_CTRL_gov_init_angref(x,y,t,ev,param,flag,model_no)
...
if nargin == 0
clc;
disp('Model: MDL_CTRL_gov_init_angref');
disp('dynamic_states:  Torder');
disp('external_states:  VQ1 TMECH W');
disp('parameters:  Setpoint angle0');
disp('--------------------------------------------------');
disp('Summary:');
disp('--------------------------------------------------');
disp('Number of x = 1');
